...
$options = array (
    ...
    array(  "name" => __('Cufon settings', 'lightword'),
            ...
            "options" => array(__('Disabled','lightword'), __('Enabled','lightword'), __('Extra','lightword')),
...
<div class="stuffbox">
<h3><label for="link_url"><?php _e('Search for help','lightword'); ?> (<a href="http://www.lightwordtheme.com">blog</a> <?php _e('or','lightword'); ?> <a href="http://twitter.com/andreiluca">twitter</a>)</label></h3>
<div class="inside">
<?php
...
$cufon_header_script = "\n<script src=\"".get_bloginfo('url')."/wp-content/themes/lightword/js/cufon.js\" type=\"text/javascript\"></script>\n<script src=\"".get_bloginfo('url')."/wp-content/themes/lightword/js/mp.font.js\" type=\"text/javascript\"></script>";
